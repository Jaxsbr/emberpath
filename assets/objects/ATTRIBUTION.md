...
| cottage | false | cozy cottage seen from a high top-down angle — a cross-gabled red roof is the dominant shape (seen from above, NO receding side wall / NO iso corner) with a short front wall + door at the bottom, 128×128 over a 4×4 footprint (regenerated 2026-06-14 via `create_map_object` — replaced the earlier isometric/3-4 dollhouse cottage that floated against the flat tiles, per Jaco directive #344 / Issue #78) | `8af491de-b0aa-423b-a709-958d5e740e51` |
