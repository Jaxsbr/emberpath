...
export interface AreaDefinition {
  ...
  // `clearedWhen` (optional, FB-20): a flag condition (same grammar as
  // conditionalObjective, e.g. 'has_ember_mark == true'). Once it holds the
  // beacon stops rendering — the "find the smoke" goal is met, so the plume +
